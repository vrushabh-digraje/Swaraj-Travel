...
export const metadata: Metadata = {
  title: "Mumbai to Mahabaleshwar Cab | Transparent Fares, Swaraj Travels",
  description:
  ...
  alternates: {
    canonical: "https://www.swarajtravel.com/mumbai-to-mahabaleshwar-cab",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Mumbai to Mahabaleshwar Cab — Transparent Fare Booking | Swaraj Travels",
    description:
    ...
    url: "https://www.swarajtravel.com/mumbai-to-mahabaleshwar-cab",
    siteName: "Swaraj Travels",
    locale: "en_IN",
    type: "website",
    images: [
      {
        url: "https://www.swarajtravel.com/images/mahabaleshwar-cab-hero-swaraj-travels.webp",
        width: 1200,
        height: 600,
        alt: "Mumbai to Mahabaleshwar cab by Swaraj Travels on the highway",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Book a reliable Mumbai to Mahabaleshwar cab with clear upfront fares. One way & round trip options. Call/WhatsApp: +91-8856904131",
    images: ["https://www.swarajtravel.com/images/mahabaleshwar-cab-hero-swaraj-travels.webp"],
  },
};
...
function mahabaleshwarUnifiedSchema() {
  return {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.swarajtravel.com/mumbai-to-mahabaleshwar-cab",
        name: "Mumbai to Mahabaleshwar Cab Booking with Swaraj Travels",
        description:
          "Book a Mumbai to Mahabaleshwar cab with clear fares, no hidden charges, and easy online booking. One way and round trip options available.",
        url: "https://www.swarajtravel.com/mumbai-to-mahabaleshwar-cab",
        headline: "Mumbai to Mahabaleshwar Cab | Transparent Fares, Swaraj Travels",
        breadcrumb: {
          "@id": "#breadcrumb",
        },
        mainEntity: {
        ...
        potentialAction: {
          ...
          target: {
            "@type": "EntryPoint",
            urlTemplate: "https://www.swarajtravel.com/search?q={search_term_string}",
          },
      ...
      },
      {
        ...
        width: 1200,
        height: 600,
        caption: "Mumbai to Mahabaleshwar cab by Swaraj Travels on the highway",
        name: "Mumbai to Mahabaleshwar cab by Swaraj Travels on the highway",
      },
      {
        "@type": "FAQPage",
        "@id": "#faq",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "Mumbai to Mahabaleshwar Cab",
            item: "https://www.swarajtravel.com/mumbai-to-mahabaleshwar-cab",
          },
        ],
      },
    ],
