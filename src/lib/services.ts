...
export const SERVICES: ServiceItem[] = [
  ...
  {
    slug: "one-way-pickup-drop",
    title: "One Way Pickup Drop",
    description: "Comfortable and hassle-free one-way drops between Mumbai and Pune or Pune to Mumbai.",
    price: "",
    features: ["Mumbai to Pune", "Pune to Mumbai", "Expressway tolls extra", "Ghat experienced drivers"],
  },
  {
    slug: "city-rides",
    title: "City Rides",
