      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-gray-600">
            Compare transparent rates across our well-maintained fleet. Looking for local sightseeing? Explore our{" "}
            <Link
              href="/mumbai-darshan-cab"
              className="font-semibold text-primary underline hover:text-primary/80"
            >
              Mumbai Darshan cab packages
            </Link>{" "}
            from ₹1,120.
          </p>
        </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                          ...
                          {row.seating.toLowerCase().includes("seater") ? row.seating : `${row.seating} Seater`}
                        </p>
                      </div>
                    </div>
